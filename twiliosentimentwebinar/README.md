...
This is a sample template for twiliosentimentwebinar - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name twiliosentimentwebinar \
...
```bash
sam logs -n HelloWorldFunction --stack-name twiliosentimentwebinar --tail
```
...
```bash
aws cloudformation delete-stack --stack-name twiliosentimentwebinar
```
